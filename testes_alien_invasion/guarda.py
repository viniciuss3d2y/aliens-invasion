...
from alien import Alien, create_aliens, create_aliens
import update
...
def run_game():
    ...
    aumenta_velocidade = 1
    player_pontuacao = 0

    total_pontos = 0
    with open('recorde_player.py') as arquivo:
    ...
    while True:
        ...
        for event in pygame.event.get():
            ...
            if event.type == pygame.MOUSEBUTTONDOWN:
                ...
                if icone_suport.rect.collidepoint(click_mouse_x, click_mouse_y):
        ...
        if game_activate:
            ...
            update.chatgpt(aliens, nave.screen_rect)
